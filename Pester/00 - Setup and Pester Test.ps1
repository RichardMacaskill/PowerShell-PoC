...
Describe "Testing for Presentation" {
    Context "Surface Book" {
        ...
        It "Should have the correct PowerPoint Presentation Open" {
            (Get-Process POWERPNT  -ErrorAction SilentlyContinue).MainWindowTitle| Should Be 'Green is Good Red is Bad - Turning Your Checklists into Pester Tests.pptx - PowerPoint'
        }
