<#
  For more information and a worked example refer to https://documentation.red-gate.com/sdps1/classification/accelerate-your-classification-with-powershell .
#>
...
function Add-RegisteredSqlServerInstance {
    ...
    process {
        ...
        $AddUrl = $ServerRootUrl + "api/v1.0/instances"
...
function Get-TagCategories {
    $url = $ClassificationURL + "api/v1.0/tagcategories"
...
function Get-Tags {
    ...
    $url = $ClassificationURL + "api/v1.0/tagcategories/" + $tagCategoryId + '/tags'
...
function Get-RegisteredInstances {
    $url = $ClassificationURL + "api/v1.0/instances"
...
function Update-ColumnWithTagIds {
    ...
    param(
        ...
        [Parameter(Mandatory = $true)] [string[]] $tagIds
    )
    process {
        $url = $ClassificationURL +
        "api/v1.0/instances/" + $column.instanceId +
...
function Import-ColumnsTags {
    ...
    $url = $ClassificationURL + 'api/v1.0/columns/bulk-classification'
    $body = @{
