...
function Get-DataSet{
    ...
    if($DataSetLabel -eq 'PhoneNumber'){
        [xml]$dataSetXml = '
    ...
    if($DataSetLabel -eq 'BankSortCode'){
        [xml]$dataSetXml = '
    ...
    if($DataSetLabel -eq 'AddressLine'){
        [xml]$dataSetXml = '
