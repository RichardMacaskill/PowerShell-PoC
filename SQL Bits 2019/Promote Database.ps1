...
$buildArtifact = New-DatabaseBuildArtifact -InputObject $validatedSchema `
    -PackageId 1.0.1 -PackageVersion 1.0.1 -Verbose
...
$buildArtifact | Publish-DatabaseBuildArtifact -DlmDashboardUrl http://rm-iclone1.testnet.red-gate.com:19528 -Verbose
