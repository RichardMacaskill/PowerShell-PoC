...
$databasePackage = New-DlmDatabasePackage $validatedSchema -PackageId 1.0.0 `
-PackageVersion 1.0.0 -Documentation $documentation -PackageDescription 'My new database package' 
